function r = vrrotvec2(a, b, options)
...
an = sl3dnormalize2(a, epsilon);
bn = sl3dnormalize2(b, epsilon);
...
ax = sl3dnormalize2(cross(an, bn), epsilon);
...
if ~any(ax)
    ...
    c = zeros(1,3);
    c(mind) = 1;
    ax = sl3dnormalize2(cross(an, c), epsilon);
end
